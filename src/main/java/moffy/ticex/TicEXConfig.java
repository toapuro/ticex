...
public class TicEXConfig {
    ...
    public static void registerConfig() {
        ...
        FLUID_TRANSMUTER_EXCLUDE_PATTERNS = COMMON.comment("A list of tag prefixes to exclude in the Fluid Transmuter").define(
                "fluid_transmuter_exclude_patterns",
                List.of("minecraft:water", "minecraft:lava"));
        COMMON.pop();
